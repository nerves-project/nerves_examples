...
Functionally similar to `blinky`, but showing how the Linux `/sys/class/leds` interface can be used to blink the LED(s) instead of manually turning them on and off.
